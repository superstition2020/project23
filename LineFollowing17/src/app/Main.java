...
public class Main {
    public static void main(String[] args) {
        ...
        robotController.start();   // Start the robot controller thread
        
        // Main thread continues to run until ESCAPE button is pressed

        while (!Button.ESCAPE.isDown()) {
            // Main thread continues to run
        }
        
        // Stop the robot controller when ESCAPE button is pressed
...
//Class responsible for controlling the robot behaviour
